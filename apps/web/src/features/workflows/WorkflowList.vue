...
<template>
  <div class="list-page">
    <header class="app-header"><RouterLink to="/" class="brand"><span class="brand-mark">⌘</span> Graph Engineering</RouterLink><RouterLink to="/settings/connections" class="back-link">Model connections</RouterLink><RouterLink to="/runs" class="back-link">Runs</RouterLink><span class="local-badge"><span></span> Local workspace</span></header>
    <main class="workflow-library">
      ...
      <div class="milestone-note"><span class="tag">M3 · WORKFLOWS</span><p>Create, connect, and save workflows on this computer. Configure explicit data bindings, then review and confirm each run.</p></div>
      ...
      <footer class="library-footer">Stored locally with SQLite <span>·</span> Explicit input. Sequential execution.</footer>
    </main>
  </div>
</template>
